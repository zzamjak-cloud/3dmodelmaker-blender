...
def _submodules():
    ...
    from .core import loop, prompts, executor, capture, runner, session, persist, native_input, multiview, library, snapshots
    ...
    return (
        ...
        loop, prompts, executor, capture, runner, multiview, library, snapshots, session, persist, native_input,
        export, assets,
    )
