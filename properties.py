...
class LP3DJobItem(bpy.types.PropertyGroup):
    ...
    scene_size: EnumProperty(
        ...
        items=[
            # 번호를 고정한다 — .blend에는 순번이 저장되므로 중간에 끼운 항목이 기존 M·L 값을 바꾸면 안 된다
            ('S', "실내 (건물 내부)", "약 12m 방·홀·상점 내부 — 지형 대신 바닥·벽을 만들고 가구를 촘촘히 배치", 0),
            ('SPOT', "스팟", "약 12m 옥외 한 장소 — 캠프파이어·우물가·노점 하나·버스 정류장", 3),
            ('SITE', "소구역", "약 24m — 건물 한두 채와 마당 (주유소 한 곳·농가 마당·골목 한 블록)", 4),
            ('M', "구역", "약 40m — 건물 여러 채와 주변 요소가 들어가는 특정 구역", 1),
            ('L', "대규모", "약 100m — 대도시·대형 성채", 2),
        ],
        default='M',
    )
